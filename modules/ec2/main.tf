...
resource "null_resource"  "ansible-pull" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "ansible-pull -i localhost, -U https://github.com/its-amanihub/roboshop-ansible roboshop.yml -e env=${var.env} -e component=${var.component_name} -e app_name=${var.component_name}"
